...
<head>
    <meta charset="UTF-8">
    <title>Print PTH INVOICE - <?= escape_html($order['order_number']) ?></title>
    <style>
        :root {
            --primary-dark: #1a1a1a;
            --accent-gold: #FFC107;
...
<body onload="window.print()">
    ...
    <div class="page">
        ...
        <header class="header">
            ...
            <div class="doc-title-box">PTH INVOICE</div>
        </header>
...
<div class="section-header-bar">
        ...
        <div style="margin-top: 50px; text-align: center; font-size: 9px; color: #aaa;">
            MJR COMPANY | PTH INVOICE â€” System Generated | Page 1 of 1
        </div>
    </div>
</body>
</html>
